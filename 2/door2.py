SPREADSHEET = "3751	3769	2769	2039	2794	240	3579	1228	4291	220	324	3960	211	1346	237	1586\n" \
...
def solve(spreadsheet):
    ...
    return sum([max(map(int, line.split())) - min(map(int, line.split())) for line in lines])
...
if __name__ == '__main__':
    print("Part One: {}".format(solve(SPREADSHEET)))
    print("Part Two: {}".format(solve2(SPREADSHEET)))
